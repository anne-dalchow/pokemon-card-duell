  ...
  playerCards.forEach((card, index) => {
    playerCardsDiv.innerHTML += `
                      <div class="card" onclick="selectPlayerCard(${index})">
                        ...
                        <div class="card-image"><img src="${card.sprites.front_default}" alt="${card.name}"></div>
...
function displaySelectedPlayerCard() {
  document.getElementById("selected-player-card").innerHTML = `
            <div class="card">
                ...
                <div class="card-image"><img src="${currentPlayerCard.sprites.front_default}" alt="${currentPlayerCard.name}"></div>
                <div class="card-skill-container">
...
function displayFullComputerCard() {
  document.getElementById("selected-computer-card").innerHTML = `
      <div class="card">
          ...
          <div class="card-image"><img src="${currentComputerCard.sprites.front_default}" alt="${currentComputerCard.name}"></div>
          <div class="card-skill-container">
